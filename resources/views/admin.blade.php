    ...
    <body class="">
        ...
        <table>
            ...
            <tr>
                ...
                <td><span><a href='admin/edit/{{$page->id}}'><button>Изменить</button></a></span></td>
                ...
                <td><span><a href="{{$page->url}}"><button>Смотреть</button></a></span></td>
            </tr>           
                  
       @endforeach
        </table>
        <span><a href="admin/create"><button> Добавить новую</button></a></span>
    </body>
</html>
